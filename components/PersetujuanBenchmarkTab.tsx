...
export default function PersetujuanBenchmarkTab({
  ...
  return (
    <div className="space-y-6 pb-12 font-sans">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-[#2563EB] via-[#1D4ED8] to-[#1E3A8A] text-white p-6 md:p-8 rounded-2xl shadow-xl relative overflow-hidden border border-blue-500/30">
      ...
      <AnimatePresence>
        {selectedRequestForDetail && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
            ...
            >
              {/* Modal Header */}
              <div className="p-5 bg-gradient-to-r from-[#2563EB] via-[#1D4ED8] to-[#1E3A8A] text-white flex items-center justify-between">
