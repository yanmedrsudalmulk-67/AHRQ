...
-- 5. Klik tab menu "Import" di bagian atas.
-- 6. Klik tombol "Browse..." / "Choose File", pilih file `schema.sql` ini.
-- 7. Gulir ke bawah dan klik tombol "Go" / "Kirim".
-- ==============================================================================
...
-- ------------------------------------------------------------------------------
-- SEED DATA AWAL (Opsional / Rekomendasi)
-- Data master nilai benchmark AHRQ SOPS 2.0 (Standar Nasional)
-- ------------------------------------------------------------------------------
